...
* Analyzed code of Drysdale again. Found a mismatch in our p-value definition at the end of carve.linear. We should account for the signs of beta_select, as the p-values should capture the extreme realizations in both the positive and negative directions.
...
knitr::include_graphics("QQ_plots_carve_linear_version1(N=1000).png")
```
...
knitr::include_graphics("QQ_plots_carve_linear_with_eta_var(N=1000).png")
```
...
knitr::include_graphics("QQ_plots_without_normalization.png")
```
...
knitr::include_graphics("histogram_without_normalization.png")
```
