...
* Regarding the normalization: Drysdale also does \texttt{y_M = self.y_screen - self.y_screen.mean()} in his \texttt{_inference_on_screened} function.

Changes in carve_linear_clean:

* Changed the variable name \textit{sigma} to \textit{sigma_squ} where necessary to avoid confusion.
