...
* How to adjust the numbers of the equations

* Mention that $A_0$ and $A_1$ should be rbound in the PoSI chapter. (Done)

* Change $\tilde S$ to $\hat S$

* Change single entries of vectors from bold to non-bold
...
* 2.4: Replace $\hat \beta^D$ by $\hat \beta^{Comb}$

* 2.5: Replace $X_j$ with $X^{(j)}$ 
