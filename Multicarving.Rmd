...
knitr::include_graphics("plots/histogram_and_cdf_of_screened_pvals_valid_constraints(N=3000)_changed_parameters.png")
```
...
knitr::include_graphics("plots/Empirical PDF beta_split whole, s=1143.png")
```

```{r, echo=FALSE,fig.cap="Empirical pdf of coefficients of $\\beta^{Split}$ for s=1143", out.width = "450px"}
knitr::include_graphics("plots/Empirical PDF beta_posi whole, s=1143.png")
```
