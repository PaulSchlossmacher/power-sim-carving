...
carve.linear.test <- function(x, y, split, beta, lambda,
...
#   
#  return(list(MPInv=x.Ma.i, y.a=y.a, x.Ma=x.Ma, C=C, A.1=A.1, x.Ma.i=x.Ma.i,
#              vlo=vlo, vup=vup, den=den, n.a=n.a, p=p, s=s, v0=v0))
  return(list(MPInv=x.Ma.i, y.a=y.a, x.Ma=x.Ma, C=C, A.1=A.1, x.Ma.i=x.Ma.i,
              vlo=vlo, vup=vup, den=den, n.a=n.a, p=p, s=s, v0=v0, norm_consts=norm_consts))
}
