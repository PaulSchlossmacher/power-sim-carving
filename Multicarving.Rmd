...
\centering
\subfloat[Power]{
  \includegraphics[width=0.49\linewidth]{plots/PowerPlot_diff_fraqs_s=5_sigma=2.png}
}
\subfloat[Type I error]{
  \includegraphics[width=0.49\linewidth]{plots/TypeIPlot_diff_fraqs_s=5_sigma=2.png}
}
\caption{Distribution of p-values for $n=100, p=200, s=15, \sigma=1, n_{sim}=200$}
\label{fig:subfigures_s=15}
\end{figure}
