...
* Mention that $A_0$ and $A_1$ should be rbound in the PoSI chapter.

* Change $\tilde S$ to $\hat S$

* Change single entries of vectors from bold to non-bold

* Change definition of $\hat s$ ($\forall j \in \hat M$)

* PoSI: Check whether $s=\#M_A, n_A$ get defined at any point before, define $\Sigma$ and mention the distribution of $\hat \beta^{PoSI}$, also explicitly put in what TN means.
