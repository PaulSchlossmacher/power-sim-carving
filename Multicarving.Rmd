...
Now that the distribution of the p-values seemed to be correct, we took another look at the power and Type-I-Error simulations:

\begin{figure}[htbp]
\centering
\subfloat[one plot]{
  \includegraphics[width=0.49\linewidth]{plots/ecdf_plots_screen_and_noscreen.png}
}
\subfloat[the other one]{
  \includegraphics[width=0.49\linewidth]{plots/ecdf_plots_screen_and_noscreen.png}
}
\caption{Distribution of p-values for $n=100, p=200, fraq=0.7, s=5, \sigma=1.9$}
