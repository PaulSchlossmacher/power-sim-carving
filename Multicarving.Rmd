...
```{r, echo=FALSE,fig.cap="Histogram and empirical cdf of p-values under screening obtained from carve.linear without normalization of truncation limits and fixed vlo/vup under new parameters."}
...
```{r, echo=FALSE,fig.cap="Empirical pdf of coefficients of beta_split for s=1143"}
