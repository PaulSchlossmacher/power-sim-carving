...
Looked at the distribution of $\hat \beta^{Split}$ and $\hat \beta^{Posi}$: I still have to think again about which coefficients we should actually observe here, but I got these two plots that are bimodal around 0 and 1:
