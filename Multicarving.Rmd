...
\end{align*}
for some epsilon following the standard distribution. Unfortunately this \sigma has to be the standard deviation, so just inserting a square root at this data generation step resolved our problems and we now finally have uniform p-values under screening as in figure ?
